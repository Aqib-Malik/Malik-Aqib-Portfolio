<template>
   <div id="wrap">
    ...
    <!-- navbar -->
    <navbar/>
        <header id="hea" class="masthead  text-center">
      <div id="hea" class="container d-flex align-items-center flex-column text-white">
...
<br> -->
        ...
        <div class="divider-custom divider divider-light">
          ...
          <div class="divider-custom-icon">
            <!-- <font-awesome-icon icon="fa-thin fa-album-circle-user" /> -->
        ...
        <p class="masthead-subheading font-weight-light mb-0">
          Full Stack Developer<!-- Graphic Artist - Web Designer - Illustrator -->
        </p>
      </div>
    </header>
    ...
    <!-- skills Section-->
    <section class="page-section   mb-0" id="skill">
      <skills/>
    </section>
    <!-- Footer-->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            <a class="btn btn-outline-light btn-social mx-1" href="https://web.facebook.com/malik.aqib.90834" target="_blank"
              ><i class="fab fa-fw fa-facebook-f"></i
            ></a>
            <a class="btn btn-outline-light btn-social mx-1" href="https://github.com/Aqib-Malik" target="_blank"
              ><i class="fab fa-fw fa-github"></i
            ></a>
            <!-- <a class="btn btn-outline-light btn-social mx-1" href="#!"
              ><i class="fab fa-fw fa-linkedin-in"></i
            ></a>-->
            <a class="btn btn-outline-light btn-social mx-1" href="https://www.instagram.com/malik.aqib.90834/" target="_blank"
              ><i class="fab fa-fw fa-instagram"></i
            ></a> 
          </div>
          <!-- Footer About Text-->
          <div class="col-lg-4">
            <h4 class="text-uppercase mb-4">About Aqib</h4>
            <p class="lead mb-0">
...
Online 24/7
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small>Copyright &copy; Malik Aqib 2022</small>
      </div>
    </div>
    <!-- Portfolio Modals-->
    <!-- Portfolio Modal 1-->
    ...
    <!-- <nav class="navbar">
    <ul class="link-group">
        <li v-on:click="navTo('')" class="link active"><a href="#">home</a></li>
        <li class="link"><a href="#">projects</a></li>
        <li class="link"><a href="#">about</a></li>
        <li v-on:click="navTo('contact_us')" class="link"><a href="#">contact</a></li>
    </ul>
</nav> -->
  </div>
</template>
